...
- `RESTRICCIONES_TECNICAS.md`: Java 21/Spring Boot 3.5/MySQL 8.4/Node 24, arquitectura y seguridad.
- `GUIA_SESIONES_S2_S6.md`: entregable S2.
- `database/REQUISITOS_NORMALIZACION_3FN.md`: modelado propio y justificación.
